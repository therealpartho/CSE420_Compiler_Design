...
statement : var_declaration
        ...
        | PRINTLN LPAREN ID RPAREN SEMICOLON
        {
                ...
                symbol_info *var = sym_table->lookup($3->getname());
                if(var == NULL)
                {
...
variable : ID
        {
                ...
                else
                {
                    ...
                    if(var->get_symbol_kind() == "array")
                    {
                        ...
                        $$ = new symbol_info($1->getname(),"varbl");
                        $$->set_data_type("__error_array__"); // Special marker for array error
                        $$->set_symbol_kind(var->get_symbol_kind());
                        $$->set_error_reported(true); // Mark as error already reported
                    }
                    else
                    {
                        $$ = new symbol_info($1->getname(),"varbl");
...
unary_expression : ADDOP unary_expression
        {
                ...
                $$->set_error_reported($2->get_error_reported()); // Propagate error flag
        }
        ...
        | factor
        {
                ...
                $$->set_data_type($1->get_data_type());
                $$->set_error_reported($1->get_error_reported()); // Propagate error flag
        }
        ;
