...
{
       0,    63,    63,    71,    77,    85,    91,   100,    99,   134,
     133,   155,   162,   169,   177,   188,   187,   207,   226,   235,
     242,   249,   258,   276,   295,   313,   334,   340,   348,   354,
     360,   366,   372,   378,   384,   390,   396,   410,   425,   431,
     439,   472,   507,   514,   552,   559,   575,   582,   598,   605,
     625,   632,   683,   698,   713,   723,   732,   792,   799,   806,
     813,   827,   843,   853,   860,   876
};
#endif
                ...
                for(auto &p : param_list_store)
                {
                    if(p.second != "")
                    {
                        ...
                        if(!sym_table->insert(param_sym))
                            log_error("Multiple declaration of variable " + p.second + " in parameter of " + (yyvsp[(2) - (5)])->getname());
                    }
                }
                param_list_store.clear();
...
#line 134 "22301572.y"
    {
                ...
                if(!sym_table->insert(func_sym))
                    log_error("Multiple declaration of function " + (yyvsp[(2) - (4)])->getname());
...
#line 156 "22301572.y"
    {
                ...
                param_list_store.push_back({(yyvsp[(3) - (4)])->getname(), (yyvsp[(4) - (4)])->getname()});
        }
    break;
...
#line 163 "22301572.y"
    {
                ...
                param_list_store.push_back({(yyvsp[(3) - (3)])->getname(), ""});
        }
    break;
...
#line 170 "22301572.y"
    {
                ...
                param_list_store.clear();
                param_list_store.push_back({(yyvsp[(1) - (2)])->getname(), (yyvsp[(2) - (2)])->getname()});
        }
    break;
...
#line 178 "22301572.y"
    {
                ...
                param_list_store.clear();
                param_list_store.push_back({(yyvsp[(1) - (1)])->getname(), ""});
        }
    break;
...
#line 259 "22301572.y"
    {
                ...
                if(!sym_table->insert(var))
                    log_error("Multiple declaration of variable " + (yyvsp[(3) - (3)])->getname());
        }
    break;
...
#line 277 "22301572.y"
    {
                ...
                arr->set_array_size(stoi((yyvsp[(5) - (6)])->getname()));
                if(!sym_table->insert(arr))
                    log_error("Multiple declaration of variable " + (yyvsp[(3) - (6)])->getname());
        }
    break;
...
#line 296 "22301572.y"
    {
                ...
                var->set_data_type(current_type);
                if(!sym_table->insert(var))
                    log_error("Multiple declaration of variable " + (yyvsp[(1) - (1)])->getname());
        }
    break;
...
#line 314 "22301572.y"
    {
                ...
                arr->set_symbol_kind("array");
                arr->set_data_type(current_type);
                arr->set_array_size(stoi((yyvsp[(3) - (4)])->getname()));
                if(!sym_table->insert(arr))
                    log_error("Multiple declaration of variable " + (yyvsp[(1) - (4)])->getname());
        }
    break;
...
#line 397 "22301572.y"
    {
                ...
                // Check if the ID in printf is declared
                symbol_info *var = sym_table->lookup((yyvsp[(3) - (5)])->getname());
                if(var == NULL)
                {
...
#line 411 "22301572.y"
    {
                ...
                if((yyvsp[(2) - (3)])->get_data_type() == "void")
                {
...
#line 440 "22301572.y"
    {
                ...
                symbol_info *var = sym_table->lookup((yyvsp[(1) - (1)])->getname());
                if(var == NULL)
                {
                    log_error("Undeclared variable " + (yyvsp[(1) - (1)])->getname());
                    (yyval) = new symbol_info((yyvsp[(1) - (1)])->getname(),"varbl");
                    (yyval)->set_data_type("int"); // default type
                    (yyval)->set_error_reported(true);
                }
                else
                {
                    // Check if array is used without indexing
                    if(var->get_symbol_kind() == "array")
                    {
                        log_error("variable is of array type : " + (yyvsp[(1) - (1)])->getname());
                        (yyval) = new symbol_info((yyvsp[(1) - (1)])->getname(),"varbl");
                        (yyval)->set_data_type("__error_array__"); // Special marker for array error
                        (yyval)->set_symbol_kind(var->get_symbol_kind());
                        (yyval)->set_error_reported(true); // Mark as error already reported
                    }
                    else
                    {
                        (yyval) = new symbol_info((yyvsp[(1) - (1)])->getname(),"varbl");
...
#line 473 "22301572.y"
    {
                ...
                else
                {
                    ...
                    if((yyvsp[(3) - (4)])->get_data_type() != "int" && (yyvsp[(3) - (4)])->get_data_type() != "")
                    {
                    ...
                    (yyval) = new symbol_info((yyvsp[(1) - (4)])->getname()+"["+(yyvsp[(3) - (4)])->getname()+"]","varbl");
                    (yyval)->set_data_type(var->get_data_type());
                    (yyval)->set_is_array_access(true);
                }
        }
    break;
...
#line 515 "22301572.y"
    {
                ...
                string left_type = (yyvsp[(1) - (3)])->get_data_type();
                string right_type = (yyvsp[(3) - (3)])->get_data_type();
                
                // Check if left operand is array
                if((yyvsp[(1) - (3)])->get_symbol_kind() == "array" && !(yyvsp[(1) - (3)])->get_is_array_access())
                {
                    log_error("variable is of array type : " + (yyvsp[(1) - (3)])->getname());
                }
...
#line 560 "22301572.y"
    {
                ...
                (yyval)->set_data_type("int"); // Result of logical operation is int
        }
    break;
...
#line 583 "22301572.y"
    {
                ...
                (yyval)->set_data_type("int"); // Result of relational operation is int
        }
    break;
...
#line 633 "22301572.y"
    {
                ...
                if(op == "%")
                {
                    ...
                    if((yyvsp[(1) - (3)])->get_data_type() != "" && (yyvsp[(1) - (3)])->get_data_type() != "int")
                    {
                        log_error("Modulus operator on non integer type");
                    }
                    if((yyvsp[(3) - (3)])->get_data_type() != "" && (yyvsp[(3) - (3)])->get_data_type() != "int")
                    {
                        log_error("Modulus operator on non integer type");
                    }
...
#line 684 "22301572.y"
    {
                ...
                (yyval)->set_error_reported((yyvsp[(2) - (2)])->get_error_reported()); // Propagate error flag
        }
    break;
...
#line 699 "22301572.y"
    {
                ...
                (yyval)->set_data_type("int"); // Logical NOT returns int
                (yyval)->set_error_reported((yyvsp[(2) - (2)])->get_error_reported()); // Propagate error flag
        }
    break;
...
#line 714 "22301572.y"
    {
                ...
                (yyval)->set_data_type((yyvsp[(1) - (1)])->get_data_type());
                (yyval)->set_error_reported((yyvsp[(1) - (1)])->get_error_reported()); // Propagate error flag
        }
    break;
...
#line 724 "22301572.y"
    {
                ...
                (yyval)->set_data_type((yyvsp[(1) - (1)])->get_data_type());
                (yyval)->set_symbol_kind((yyvsp[(1) - (1)])->get_symbol_kind());
                (yyval)->set_error_reported((yyvsp[(1) - (1)])->get_error_reported()); // Propagate error flag
        }
    break;
...
#line 733 "22301572.y"
    {
                ...
                symbol_info *func = sym_table->lookup((yyvsp[(1) - (4)])->getname());
                ...
                else
                {
                    ...
                    vector<string> arg_types = (yyvsp[(3) - (4)])->get_param_types(); // We'll store arg types here
                    ...
                    {
                        // Check each argument type - even if count matches, types might not
                        bool has_type_mismatch = false;
                        for(size_t i = 0; i < arg_types.size(); i++)
                        {
                            if(arg_types[i] != "" && param_types[i] != "")
                            {
                                // Skip if it's already an error marker
                                if(arg_types[i] == "__error_array__")
                                    continue;
                                    
                                // For function calls, be strict - floats and ints are NOT compatible
                                if(arg_types[i] != param_types[i])
                                {
                                    // Only report if not a void type (void errors are reported elsewhere)
                                    if(arg_types[i] != "void" && param_types[i] != "void")
                                    {
...
#line 814 "22301572.y"
    {
                ...
                // Check for void type
                if((yyvsp[(1) - (2)])->get_data_type() == "void")
                {
                    log_error("operation on void type");
                }
...
#line 844 "22301572.y"
    {
                ...
                // Copy all argument types from arguments
                for(auto &p : (yyvsp[(1) - (1)])->get_param_types())
                    (yyval)->add_param_type(p);
        }
    break;
...
#line 861 "22301572.y"
    {
                ...
                for(auto &p : (yyvsp[(1) - (3)])->get_param_types())
                    (yyval)->add_param_type(p);
                // Add current argument type
                (yyval)->add_param_type((yyvsp[(3) - (3)])->get_data_type());
                
                // Track if this argument has an error
                if((yyvsp[(3) - (3)])->get_error_reported())
                    (yyval)->set_error_reported(true);
        }
    break;
...
#line 877 "22301572.y"
    {
                ...
                (yyval)->add_param_type((yyvsp[(1) - (1)])->get_data_type());
                (yyval)->set_error_reported((yyvsp[(1) - (1)])->get_error_reported()); // Propagate error flag
        }
    break;
