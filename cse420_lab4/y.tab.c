...
static const yytype_uint16 yyrline[] =
{
     ...
     639,   652,   663,   676,   721,   763,   772,   812,   821,   856,
     865,   900,   910,   950,   960,  1035,  1060,  1085,  1098,  1107,
    1181,  1190,  1202,  1214,  1230,  1248,  1256,  1267,  1290
};
#endif
...
#line 677 "syntax_analyzer.y"
    {
		...
		VarNode* varNode = new VarNode((yyvsp[(1) - (1)])->getname(), (yyval)->getvartype(), nullptr, symtbl->getID());
...
#line 722 "syntax_analyzer.y"
    {
		...
		VarNode* varNode = new VarNode((yyvsp[(1) - (4)])->getname(), (yyval)->getvartype(), (ExprNode*)(yyvsp[(3) - (4)])->get_ast_node(), symtbl->getID());
		(yyval)->set_ast_node(varNode);
	 }
    break;
