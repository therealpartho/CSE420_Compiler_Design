...
variable : id_name 	
      {
		...
		VarNode* varNode = new VarNode($1->getname(), $$->getvartype(), nullptr, symtbl->getID());
	 ...
	 | id_name LTHIRD expression RTHIRD 
	 {
		...
		VarNode* varNode = new VarNode($1->getname(), $$->getvartype(), (ExprNode*)$3->get_ast_node(), symtbl->getID());
		$$->set_ast_node(varNode);
	 }
	 ;
