...
{
       0,    36,    36,    44,    50,    58,    64,    73,    72,   107,
     106,   128,   135,   142,   150,   161,   160,   180,   199,   208,
     215,   222,   231,   243,   256,   268,   283,   289,   297,   303,
     309,   315,   321,   327,   333,   339,   345,   351,   359,   365,
     373,   379,   387,   393,   401,   407,   415,   421,   429,   435,
     443,   449,   457,   463,   469,   477,   483,   489,   495,   501,
     507,   513,   521,   528,   535,   541
};
#endif
...
#line 73 "22301572.y"
    {
                ...
                if(!sym_table->insert(func_sym))
                    outlog<<"Error at line "<<lines<<": "<<(yyvsp[(2) - (5)])->getname()<<" already declared"<<endl<<endl;
                ...
                for(auto &p : param_list_store)
                {
                    if(p.second != "")
                    {
                        ...
                        if(!sym_table->insert(param_sym))
                            outlog<<"Error at line "<<lines<<": "<<p.second<<" already declared"<<endl<<endl;
                    }
                }
                param_list_store.clear();
...
#line 107 "22301572.y"
    {
                ...
                if(!sym_table->insert(func_sym))
                    outlog<<"Error at line "<<lines<<": "<<(yyvsp[(2) - (4)])->getname()<<" already declared"<<endl<<endl;
...
#line 232 "22301572.y"
    {
                ...
                if(!sym_table->insert(var))
                    outlog<<"Error at line "<<lines<<": "<<(yyvsp[(3) - (3)])->getname()<<" already declared"<<endl<<endl;
        }
    break;
...
#line 244 "22301572.y"
    {
                ...
                if(!sym_table->insert(arr))
                    outlog<<"Error at line "<<lines<<": "<<(yyvsp[(3) - (6)])->getname()<<" already declared"<<endl<<endl;
        }
    break;
...
#line 257 "22301572.y"
    {
                ...
                var->set_data_type(current_type);
                if(!sym_table->insert(var))
                    outlog<<"Error at line "<<lines<<": "<<(yyvsp[(1) - (1)])->getname()<<" already declared"<<endl<<endl;
        }
    break;
...
#line 269 "22301572.y"
    {
                ...
                if(!sym_table->insert(arr))
                    outlog<<"Error at line "<<lines<<": "<<(yyvsp[(1) - (4)])->getname()<<" already declared"<<endl<<endl;
        }
    break;
